...
def bangbae_data():
    ...
    data = {
        ...
        "comparison": [
            ...
            {"name": "우리 구역", "area": 20500, "type": "도심복합", "highlight": True},
        ...
        "strengths": [
            "서초구 핵심 입지 — 사당역 2·4호선 도보 500m",
            "방배15구역 바로 인접 — 완성 시 시너지 극대화",
            "면적 20,500㎡ — 역세권(5,000㎡) 및 주거중심형(2만㎡) 충족",
        ...
        "risks": [
            "중소형 체급 (20,500㎡) — 주변 대형 구역 대비 규모는 작으나 요건 충족",
            "일몰 리스크 — 공공주택특별법 2026.12.31 만료 (폐지 추진 중이나 불확실)",
            "수용 방식 → 양도소득세 발생 (재개발은 비과세)",
