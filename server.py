...
def bangbae_data():
    ...
    data = {
        ...
        "timeline": [
            ...
            {"date": "2026-04-30", "title": "1차 참여의향서 마감", "status": "완료", "desc": "✅ 91세대 접수 (동의율 43.1%) — 최소요건(10%) 4배 초과, 만점 기준(30%) 초과 달성"},
            {"date": "2026-05-08", "title": "공모 신청서 정식 제출", "status": "완료", "desc": "✅ 서초구청에 신청서류 제출 완료"},
            {"date": "2026년 6월", "title": "후보지 선정 발표", "status": "진행중", "desc": "⏳ 국토부·LH 선정위원회 심사 대기 중"},
            {"date": "2026년 하반기~2027", "title": "예정지구 지정", "status": "예정", "desc": "토지등소유자 2/3 이상 동의 확보 후 지정 (약 6~12개월 소요)"},
            {"date": "2027~2029", "title": "복합사업계획 승인 (인허가)", "status": "예정", "desc": "통합심의 패스트트랙 적용 (약 2~3년)"},
            {"date": "2029~2030", "title": "시공사 선정 → 이주·철거", "status": "예정", "desc": "1군 건설사 선정, 이주 및 기존 건물 철거 (약 1~2년)"},
            {"date": "2030~2033", "title": "착공 → 공사", "status": "예정", "desc": "아파트 건설 공사 (약 30~36개월)"},
        ...
        "consent": {
            ...
            "unit": "세대",
            "status": "마감",
            "note": "공모 최소요건(10%) 4배 초과 + 만점 기준(30%) 초과 달성 — 공모 신청서 정식 제출 완료, 후보지 선정 대기 중"
        },
        "comparison": [
        ...
        "strengths": [
            ...
            "66필지 214세대 (토지등소유자) — 건폐율 63.2%, 용적률 256.3%",
